...
As a proof of concept, the pipeline is applied to three 2024 flood events:

| Country | Event | Analysis Window |
|---|---|---|
| **Colombia** | Chocó and north-western corridor floods | October–November 2024 |
| **Indonesia** | Multi-province flooding | February–March 2024 |
| **Pakistan** | Seasonal monsoon floods | *2022 event; historical analysis* |

Each case study produces a **Digital Traces Situation Report (SitRep)** — a concise, policy-oriented document showing displacement estimates derived from the GPS pipeline, key validation against OCHA and IOM benchmarks, and a brief summary of data limitations. The Colombia and Indonesia SitReps are presented at the Day 1 policy workshop; the Pakistan case forms the basis for the hackathon.

## Partners {.unnumbered}

This work is led by the [Geographic Data Science Lab](https://www.liverpool.ac.uk/geographic-data-science/) at the University of Liverpool, conducted in close partnership with:

- **FCDO** (Foreign, Commonwealth & Development Office) — primary funder and policy partner
- **IOM Displacement Tracking Matrix (DTM)** — operational data partner and validation benchmark
- **Snowflake** — data infrastructure support via the [End Data Disparity](https://www.snowflake.com/en/company/overview/end-data-disparity/) initiative
